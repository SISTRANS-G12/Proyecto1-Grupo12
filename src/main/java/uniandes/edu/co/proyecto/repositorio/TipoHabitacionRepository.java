...
public interface TipoHabitacionRepository extends JpaRepository<TipoHabitacion, Integer> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO TiposHabitacion (id, nombre, capacidad, precio_noche) VALUES ( parranderos_sequence.nextval , :nombre, :capacidad, :precio_noche)", nativeQuery = true)
