...
public interface ReservaRepository extends JpaRepository<Reserva, Integer>{
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO Reservas (id, fecha_entrada, fecha_salida, numero_personas, check_in, check_out, PlanesConsumo_id, Habitaciones_id) VALUES ( proyectoHotels1_sequence.nextval , :fecha_entrada, :fecha_salida, :numero_personas, :check_in, :check_out, :PlanesConsumo_id, :Habitaciones_id)", nativeQuery = true)
    ...
    @Modifying
    @Transactional
    @Query(value = "UPDATE Reservas SET fecha_entrada = :fecha_entrada, fecha_salida = :fecha_salida, numero_personas = :numero_personas, check_in = :check_in, check_out = :check_out, PlanesConsumo_id = :PlanesConsumo_id, Habitaciones_id = :Habitaciones_id WHERE id = :id", nativeQuery = true)
